...
public class MarketingHelper {
	 ...
	 * @throws JAXBException
	 */
	public void addToMarketingFile(String text){
		MarketingData marketingData;
		try {
			marketingData = readMarketingData();
	 ...
	 * @throws JAXBException
	 */
	private void writeMarketingData(MarketingData marketingData){
		JAXBContext jaxbContext;
		try {
			jaxbContext = JAXBContext.newInstance(MarketingData.class);
