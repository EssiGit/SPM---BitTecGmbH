...
public class WekaAnalyser {
	...
	private void writeWekaResult(String csv) {
	      try {
	          FileWriter file = new FileWriter(System.getProperty("user.home") + File.separator + "KaufDort_Userfiles"+ File.separator + "Result_Files" + File.separator + "result_cluster_" + fileName);
	          file.write(csv);
	          file.close();
	       } catch (IOException e) {
